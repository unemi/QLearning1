...
@implementation ControlPanel {
	...
	IBOutlet NSButton *btnDrawByRects, *btnDrawByTriangles, *btnDrawByLines,
		...
		*cboxStartFullScr, *cboxRecordImages, *cBoxShowFPS, *cBoxRndObst,
...
- (void)windowDidLoad {
	...
	boolVBtns = @[cboxStartFullScr, cboxRecordImages, cBoxShowFPS, cBoxRndObst];
